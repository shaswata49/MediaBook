        ...
        <Card className="mb-6">
            <CardHeader className="flex flex-col p-3">
                <CardTitle className="text-sm text-center flex justify-start items-center">
                    <span className="mr-2">
                        <img src={data.photoURL} className="w-10 h-10 rounded-full border-2 border-slate-800 object-cover" alt="image"/>
                    </span>
                    <span>{data.username}</span>
                </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
                <img src={data.photos ? data.photos[0].cdnUrl : ''} alt="post"/>
            </CardContent>
